...
gctrace_chromtab = {
    ...
    "sp":   {
        "MS": {
            "N2":      {"l": 1.721*60, "r": 1.871*60, "calib": {"linear": {"slope": 1.0}}},
            "CH3OH":   {"l": 1.871*60, "r": 1.997*60, "calib": {"linear": {"slope": 1.0}}},
            "CH2O":    {"l": 2.140*60, "r": 2.195*60, "calib": {"linear": {"slope": 1.0}}},
            "CH3OCHO": {"l": 2.194*60, "r": 2.254*60, "calib": {"linear": {"slope": 1.0}}}
        },
        "TCD": {
            "CO2": {"l": 2.990*60, "r": 3.157*60, "calib": {"linear": {"slope": 1.0}}},
            "H2":  {"l": 4.312*60, "r": 4.506*60, "calib": {"linear": {"slope": 1.0}}},
            "O2":  {"l": 4.510*60, "r": 4.690*60, "calib": {"linear": {"slope": 1.0}}},
            "N2":  {"l": 4.700*60, "r": 4.965*60, "calib": {"linear": {"slope": 1.0}}}
        },
        "FID": {
            "CH3OH":   {"l": 1.850*60, "r": 2.140*60, "calib": {"linear": {"slope": 1.0}}},
            "CH3OCHO": {"l": 2.140*60, "r": 2.628*60, "calib": {"linear": {"slope": 1.0}}}
        }
    }
}
